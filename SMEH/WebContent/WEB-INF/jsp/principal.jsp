  	...
  	<div class="container">
	    ...
	    <ul class="nav nav-tabs" role="tablist">
	      ...
	      <li class="test">
	          <a href="#settings1" onclick="getTab(this);" role="tab" data-toggle="tab">
	              <i class="fa fa-cog"></i> Informaci�n de los Instrumentos/Sensores
	          </a>
	      </li>
	      <li class="test">
	          <a href="#settings2" onclick="getTab(this);" role="tab" data-toggle="tab">
	              <i class="fa fa-cog"></i> Informacion de la Instalaci�n/Montaje de los Instrumentos de la Estaci�n
	          </a>
	      </li>
	      <li class="test">
	    ...
	    <div class="tab-content">
	      ...
	      <div class="tab-pane fade" id="settings">
	          <h2>Informaci�n del Observador (incluye capacitaci�n)</h2>
              <jsp:include page="registrarObservador.jsp" />
	      </div>
	      <div class="tab-pane fade" id="settings1">
	          <h2> Informaci�n de los Instrumentos/Sensores</h2>
	      </div>
	      <div class="tab-pane fade" id="settings2">
	          <h2>Informacion de la Instalaci�n/Montaje de los Instrumentos de la Estaci�n</h2>
